...
<link href="catalog/view/theme/flavours/stylesheet/flexslider.css" rel="stylesheet">
<script type="text/javascript" src="catalog/view/theme/flavours/js/jquery.flexslider.js"></script> 
<script type="text/javascript" src="catalog/view/theme/flavours/js/cloud-zoom.js"></script>

<script src="catalog/view/javascript/jquery/owl-carousel/owl.carousel.min.js" type="text/javascript"></script>
<script src="catalog/view/theme/flavours/js/jquery.growl.js" type="text/javascript"></script>
<link href="catalog/view/theme/flavours/stylesheet/jquery.growl.css" rel="stylesheet" type="text/css" />
...
<div class="magik-quickview">
        <div class="product-view">
          <div class="product-essential">
           ...
           if ($price && $special) { ?>
           <div class="sale-label sale-top-right"><?php echo $config->get('tmflavours_sale_labeltitle'); ?></div>
           <?php } }  ?>
            ...
            <div class="product-shop col-lg-6 col-sm-6 col-xs-12">
              ...
              <div class="ratings">
                ...
                <p class="rating-links"><a href="" onclick="$('a[href=\'#reviews_tabs\']').trigger('click'); return false;"><?php echo $reviews; ?></a></p>
              </div><!-- ratings -->
               </div>
              <?php } ?>
