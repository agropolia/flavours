...
$('#review').load('index.php?route=tmblog/article/review&tmblogarticle_id=<?php echo $tmblogarticle_id; ?>');

$('#button-review').on('click', function() {
	$.ajax({
		url: 'index.php?route=tmblog/article/write&tmblogarticle_id=<?php echo $tmblogarticle_id; ?>',
		type: 'post',
		dataType: 'json',
