...
class ControllerModuleCustomSubcategoryThumbnail extends Controller {
    ...
    public function index() {
     ...
     //print_r($_POST);exit;
        ...
        foreach ($subcat_images as $tmslider_image) {
            if (is_file(DIR_IMAGE . $tmslider_image['image'])) {
                $image = $tmslider_image['image'];
                $thumb = $tmslider_image['image'];
            } else {
                $image = '';
                $thumb = 'no_image.png';
            }
            ...
            $data['subcat_images'][] = array(
                ...
                'category_id'    => $tmslider_image['category_id'],               
                'image'          => $image,
