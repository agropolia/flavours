<?php
class ModelTmblogBlog extends Model {

	public function createtableBlogTables() {
		
		$checkBlogTable = "SHOW TABLES LIKE '".DB_PREFIX."tmblog' ";
		$queryBlog=$this->db->query($checkBlogTable);
		if($queryBlog->num_rows==0){
		    $createBlogTable = "
			CREATE TABLE " . DB_PREFIX . "tmblog (
		...
		$checkBlogDespTable = "SHOW TABLES LIKE '".DB_PREFIX."tmblog_description' ";
		$queryBlogDesp=$this->db->query($checkBlogDespTable);
		if($queryBlogDesp->num_rows==0){
		    $createBlogDespTable = "
			CREATE TABLE " . DB_PREFIX . "tmblog_description (
		...
		$checkBlogCatTable = "SHOW TABLES LIKE '".DB_PREFIX."tmblog_to_category' ";
		$queryBlogCat=$this->db->query($checkBlogCatTable);
		if($queryBlogCat->num_rows==0){
		    $createBlogCatTable = "
			CREATE TABLE " . DB_PREFIX . "tmblog_to_category (
			`blog_id` int(11) NOT NULL ,
		...
		$checkBlogStoreTable = "SHOW TABLES LIKE '".DB_PREFIX."tmblog_to_store' ";
		$queryBlogStore=$this->db->query($checkBlogStoreTable);
		if($queryBlogStore->num_rows==0){
		    $createBlogStoreTable = "
			CREATE TABLE " . DB_PREFIX . "tmblog_to_store (
			`blog_id` int(11) NOT NULL ,
		...
		$checkCategoryTable = "SHOW TABLES LIKE '".DB_PREFIX."tmblogcategory' ";
		$queryCategory=$this->db->query($checkCategoryTable);
		if($queryCategory->num_rows==0){
		    $createCategoryTable = "
			CREATE TABLE " . DB_PREFIX . "tmblogcategory (
		...
		$checkCategoryDespTable = "SHOW TABLES LIKE '".DB_PREFIX."tmblogcategory_description' ";
		$queryCategoryDesp=$this->db->query($checkCategoryDespTable);
		if($queryCategoryDesp->num_rows==0){
		    $createCategoryDespTable = "
			CREATE TABLE " . DB_PREFIX . "tmblogcategory_description (
			`category_id` int(11) NOT NULL ,
			`language_id` int(11) unsigned NOT NULL,
		...
		$checkCategoryStoreTable = "SHOW TABLES LIKE '".DB_PREFIX."tmblogcategory_to_store' ";
		$queryCategoryStore=$this->db->query($checkCategoryStoreTable);
		if($queryCategoryStore->num_rows==0){
		    $createCategoryStoreTable = "
			CREATE TABLE " . DB_PREFIX . "tmblogcategory_to_store (
			`category_id` int(11) NOT NULL ,
			`store_id` int(11) NOT NULL,
	...
	public function createDefaultBlogLayout() {
		...
		$sql1 = "INSERT INTO `".DB_PREFIX."layout_route` (
				...
				VALUES (NULL , '".$id."', '0', 'tmblog/article');";
		...
		$sql2 = "INSERT INTO `".DB_PREFIX."layout_route` (
				...
				VALUES (NULL , '".$id."', '0', 'tmblog/article/tag');";
		...
		$sql3 = "INSERT INTO `".DB_PREFIX."layout_route` (
				...
				VALUES (NULL , '".$id."', '0', 'tmblog/article/view');";
		...
		$sql4 = "INSERT INTO `".DB_PREFIX."layout_route` (
				...
				VALUES (NULL , '".$id."', '0', 'tmblog/category');";
