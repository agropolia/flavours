          ...
          <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-custom_block_inside_menu" class="form-horizontal">
            ...
            <thead>
              <tr>
                ...
                <td class="text-right"><?php echo "Block content"; ?></td>
                <td></td>
              </tr>
            </thead>
              ...
              <tr>
                ...
                <td align="right">
                  <textarea name="custom_block_inside_menu_module[<?php echo $module_row; ?>][content]" placeholder="Enetr text here" class="form-control"><?php echo $module["content"]; ?></textarea>
                </td>
...
function addModule() {  
  ...
  html += '<td align="right"><textarea class="form-control" name="custom_block_inside_menu_module[' + module_row + '][content]" placeholder="Enetr text here" class="form-control"></textarea></td>';
