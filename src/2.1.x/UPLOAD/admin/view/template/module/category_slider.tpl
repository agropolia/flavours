  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-category_slider" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category_slider" class="form-horizontal">
          ...
          <table id="module" class="table table-striped table-bordered table-hover">
            <thead>
              ...
              <tr>
                <td>
                  <select name="category_slider_module[<?php echo $module_row; ?>][category_id]" class="form-control">
                  <?php foreach ($categories as $category) { ?>
                ...
                <td class="text-left">                 
                  ...
                  <input type="hidden" name="category_slider_module[<?php echo $module_row; ?>][image]" value="<?php echo $module['image']; ?>" id="input-image<?php echo $module_row; ?>" />
                </td>
...
function addModule() {  
  ...
  html += '  <tr>';
  html += '    <td><select class="form-control" name="category_slider_module[' + module_row + '][category_id]">';
  <?php foreach ($categories as $category) { ?>
  html += '      <option value="<?php echo $category["category_id"]; ?>"><?php echo addslashes($category["name"]); ?></option>';
  <?php } ?>
  html += '    </select></td>';

  html += '<td class="text-left"><a href="" id="thumb-image'+ module_row +'" data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="category_slider_module['+ module_row +'][image]" value="" id="input-image'+ module_row +'" /></td>';
