...
<button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-tmblogcomment').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
  ...
  <div class="container-fluid">
	...
	<div class="well">
        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-tmblogcomment">
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=tmblog/comment&token=<?php echo $token; ?>';
