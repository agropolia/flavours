  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-tmblogcomment" class="form-horizontal">
...
$('input[name=\'blog\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=tmblog/comment/autocomplete&token=<?php echo $token; ?>&article_name=' +  encodeURIComponent(request),
			dataType: 'json',			
