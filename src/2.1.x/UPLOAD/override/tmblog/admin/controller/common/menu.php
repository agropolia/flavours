<?php
class tmblog_ControllerCommonMenu extends ControllerCommonMenu {
    ...
    */
    public function preRender( $template_buffer, $template_name, &$data ) {
        ...
        if($this->config->get('tmblog_status')==1) {    
            $this->load->language('tmblog/blog');
	    ...
	    $data['text_blog_post'] = $this->language->get('text_blog_post');
            ...
            $data['tmblog_category'] = $this->url->link('tmblog/category', 'token=' . $this->session->data['token'], 'SSL');
	    $data['tmblog_post'] = $this->url->link('tmblog/article', 'token=' . $this->session->data['token'], 'SSL');
	    $data['tmblog_comment'] = $this->url->link('tmblog/comment', 'token=' . $this->session->data['token'], 'SSL');
    ...
    <ul>
      <li><a href="<?php echo $tmblog_category; ?>"><?php echo $text_blog_category; ?></a></li>
      <li><a href="<?php echo $tmblog_post; ?>"><?php echo $text_blog_post; ?></a></li>
      <li><a href="<?php echo $tmblog_comment; ?>"><?php echo $text_blog_comment; ?></a></li>
    </ul>
</li>',
	    $template_buffer
            );
